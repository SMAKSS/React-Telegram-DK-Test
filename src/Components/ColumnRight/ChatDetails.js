                ...
                <div ref={this.chatDetailsListRef} className='chat-details-list'>
                    ...
                    {(username || phoneNumber || bio) && (
                        <>
                            <List>
                                {username && (
                                    <ListItem button className='list-item username' onClick={this.handleUsernameHint}>
                                        <ListItemIcon>
                                            <AlternateEmailIcon />
                                        </ListItemIcon>
                                        <ListItemText
                                ...
                                {phoneNumber && (
                                    <>
                                        <ListItem
                                            button
                                            className='list-item phone-number'
                                ...
                                {bio && (
                                    <ListItem className='list-item bio'>
                                        <ListItemIcon>
